    ...
    <div class="alert-wrapper">
      <div class="alert-frame">
        <div class="alert-header ${type}-bg">
          ...
          <img class="alert-img" src="${chrome.extension.getURL("cute-alert-master/img/" + type + ".svg")}" />
        </div>
    ...
    <div class="toast-container ${type}-bg">
      <div>
        <div class="toast-frame">
          <img class="toast-img" src="${chrome.extension.getURL("cute-alert-master/img/" + type + ".svg")}" />
